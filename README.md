...
La aplicacion de captura _[capture.py](./capture.py)_ consta de todas las herramientas y funciones para realizar una captura de movimiento, con excepcion de una camara, la cual no es estrictamente necesaria para realizar una captura, aunque si para el _[posprocesado](./Docs/posprocess%20manager.md)_
